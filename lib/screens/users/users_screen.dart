                          ...
                          final confirmed = await showDialog<bool>(
                            ...
                            builder: (confirmContext) {
                              return AlertDialog(
                                ...
                                content: const Text(
                                  'سيتم تصفير جميع البيانات التشغيلية: '
                                  'المبيعات والمشتريات والدفعات والحسابات '
                                  'والمصروفات والرواتب والمخزون والتعبئة، '
                                  'وكذلك العملاء والموردين والسائقين والخزانات '
                                  'وسجلات التشغيل.\n\n'
                                  'سيتم الاحتفاظ بحسابات المستخدمين '
                                  'والصلاحيات فقط. هذه العملية لا يمكن '
                                  'التراجع عنها من داخل التطبيق.\n\n'
                                  'هل تريد المتابعة؟',
                                ),
                                actions: [
                                  TextButton(
